...
####  Save  ####
setwd(dir = "L:/Resources/Stats and Graphics/Mapping Dashboard/Data")

write.csv(tableList, file = "Variable selection_tables.csv", row.names = F)
write.csv(variableList, file = "Variable selection_variables.csv", row.names = F)
write.csv(universeList, file = "Variable selection_universes.csv", row.names = F)
